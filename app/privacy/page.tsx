  ...
  return (
    <section className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
      ...
      <div className="prose-sm space-y-8 text-neutral-300 leading-relaxed">
        <div>
          <h2 className="text-white font-bold text-lg mb-3">Wie zijn wij</h2>
          <p>
        ...
        <div>
          <h2 className="text-white font-bold text-lg mb-3">Welke gegevens verzamelen wij</h2>
          <p>
        ...
        <div>
          <h2 className="text-white font-bold text-lg mb-3">Bewaartermijn</h2>
          <p>
        ...
        <div>
          <h2 className="text-white font-bold text-lg mb-3">Uw rechten</h2>
          <p>
        ...
        <div>
          <h2 className="text-white font-bold text-lg mb-3">Klachten</h2>
          <p>
